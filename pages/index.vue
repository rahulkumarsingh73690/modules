<template>
  <div class="pb-16">
    ...
    <div class="pt-12 pb-8 container mx-auto px-4 sm:px-0">
      ...
      <!-- Categories -->
      <div
        class="flex sm:flex-wrap space-x-2 sm:justify-center pt-6 overflow-x-auto"
      >
        <button
          ...
          :class="[
            selectedCategory === category
              ? 'bg-forest-night text-white'
              : 'text-forest-night bg-rainy-grey hover:bg-grey-light focus:bg-grey-light',
          ]"
    ...
    <div class="container mx-auto px-4 sm:px-0">
        ...
        <div v-show="!q" class="mb-4 text-forest-night flex items-center">
          ...
          <div class="relative w-28">
            ...
            <div
              ...
              class="origin-top-right absolute right-0 rounded-md shadow-lg z-10"
            >
              <div
                id="options-menu"
                role="menu"
      ...
      <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
        <div
          ...
          :key="module.name"
          class="relative flex flex-col bg-white transform transition-transform duration-150 ease-in-out shadow rounded-md overflow-hidden hover:shadow-lg hover:-translate-y-1"
        >
